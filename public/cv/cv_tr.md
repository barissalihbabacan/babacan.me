...
**CTO & Baş Geliştirici (Lead Developer)** | _Garage.ist_ | Devam Ediyor

- **Sortify** ve **+TV** gibi amiral gemisi uygulamaların tüm geliştirme döngüsünü ve App Store lansmanlarını yönettim.
- Ağ tabanlı özel bir TV kontrol protokolü tasarladım ve çekirdek sistemi sıfırdan inşa ettim.
- Yerel iOS arayüzleri için SwiftUI, güçlü backend API'leri için Node.js ve TypeScript kullanarak teknik stratejiye liderlik ettim.

**IT ve Sistem Entegrasyon Stajyeri** | _ENLOG - İstanbul_ | Eyl 2023 – Haz 2024

- BT altyapısı dahilinde teknik destek, ağ operasyonları ve iş akışı optimizasyon süreçlerini yürüttüm.
...
**İstanbul Üniversitesi (AUZEF)** | _Bilgisayar Programcılığı (Önlisans)_ | 2024 – Devam Ediyor
