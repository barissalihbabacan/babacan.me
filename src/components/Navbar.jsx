      ...
      <div className="max-w-container-max mx-auto px-margin-desktop h-full flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-gutter">
          ...
          <a
            ...
            download
            className="bg-primary text-surface px-4 pt-[6px] pb-[4px] border-b-[2px] border-primary-container font-label-mono text-[10px] uppercase tracking-widest hover:bg-primary/85 transition-colors flex items-center gap-1.5"
          >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 w-full bg-surface border-b border-primary/30 px-margin-mobile py-6 space-y-4">
          ...
          <a
            ...
            download
            className="flex items-center gap-2 bg-primary text-surface px-4 pt-[8px] pb-[4px] border-b-[2px] border-primary-container font-label-mono text-[10px] uppercase tracking-widest hover:bg-primary/85 transition-colors w-fit"
