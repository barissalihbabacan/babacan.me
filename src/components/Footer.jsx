...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-primary/30 py-10">
      <div
        className="max-w-container-max mx-auto px-margin-desktop flex flex-col md:flex-row justify-between items-center gap-6"
      >
        <a
          href="/"
        ...
        <div
          className="flex flex-wrap gap-6 font-label-mono text-[10px] uppercase tracking-widest"
        >
          <a
        ...
        <div
          className="font-label-mono text-[10px] text-on-surface-variant/40 uppercase tracking-widest"
        >
