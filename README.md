...
<p align="center">
  ...
  <a href="https://github.com/barissalihbabacan/portfolio-site/actions"><img src="https://img.shields.io/github/actions/workflow/status/barissalihbabacan/portfolio-site/firebase-hosting-merge.yml?branch=main&style=for-the-badge&label=CI%2FCD&color=10b981" alt="Build Status"></a>
...
```bash
git clone https://github.com/barissalihbabacan/portfolio-site.git
cd portfolio-site
vp install
```
